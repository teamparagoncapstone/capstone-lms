...
export function DataTableRowActions<TData>({
  ...
  const [formData, setFormData] = useState<FormData>({
    ...
    password: "",
    educatorLevel: row.original.educatorLevel || "",
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        const errorText = await response.text();
        console.error("API error response:", errorText);
        throw new Error(errorText || "Failed to delete Educator");
      }
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="sm:max-w-[600px] flex flex-col">
          <DialogHeader className="flex flex-col items-center justify-center text-center">
            <DialogTitle>Update Educator Details</DialogTitle>
            <DialogDescription>
              Fill all the required fields to edit the educator details.
            </DialogDescription>
          </DialogHeader>
                ...
                <div className="flex">
                  <div className="w-1/2 mt-2 pr-4">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        handleChange("educatorLevel", value)
                      }
                    >
                      <SelectTrigger>
                      ...
                      <SelectContent>
                        <SelectItem value="EducatorOne">
                          Educator Grade 1
                        </SelectItem>
                        <SelectItem value="EducatorTwo">
                          Educator Grade 2
                        </SelectItem>
                        <SelectItem value="EducatorThree">
                          Educator Grade 3
                        </SelectItem>
                      </SelectContent>
                    </Select>
