...
export default function ModuleReadingPage() {
  ...
  const handleStartVoice = () => {
    ...
    router.push(`/grade-two-dashboard/voice-exercises?title=${title}`); 
};
  if(loading){
    return <p>Loading...</p>;
  }
        ...
        <div className="relative flex-1 p-8 md:p-4 pt-6 h-screen w-full bg-cover bg-center">
          ...
          <div className="flex flex-col md:flex-row w-full max-w-7xl">
              ...
              <Card className="w-full max-w-2xl h-[500px] bg-amber-300 shadow-2xl shadow-neutral-900 ">
                ...
                <Card className="w-full max-w-2xl h-[500px] shadow-2xl shadow-neutral-900 bg-cover bg-bottom " style={{ backgroundImage: 'url("/images/reading2.png")'}} >
