...
export default function DashboardPage() {
  ...
  useEffect(() => {
    async function fetchModules() {
      try {
        const response = await fetch("/api/grade-one-module");
  ...
  const readingModules = modules.filter(
    (module: any) => module.subjects.includes("Reading") && !module.completed
  );
                        ...
                        <Button
                          onClick={() => {
                            if (module) {
                              ...
                              router.push(
                                `/grade-one-dashboard/module-reading?${queryParams.toString()}`
                              );
                            }
                          }}
                        ...
                        <Button
                          onClick={() => {
                            if (module) {
                              ...
                              router.push(
                                `/grade-one-dashboard/module-math?${queryParams.toString()}`
                              );
                            }
                          }}
                          className="mt-4 px-6 py-2 bg-blue-500 text-white rounded-md"
