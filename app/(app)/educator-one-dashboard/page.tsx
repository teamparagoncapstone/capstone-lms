...
import TeamSwitcher from "@/app/(app)/educator-one-dashboard/components/team-switcher";
import { UserNav } from "@/app/(app)/educator-one-dashboard/components/user-nav";
    ...
    async function fetchData() {
      ...
      try {
        const [
          ...
          fetch("/api/fetch-one-Achievers", { method: "GET" }),
          fetch("/api/fetch-one-Achievers-reading", { method: "GET" }),
          fetch("/api/average-one", { method: "GET" }),
        ]);
      ...
      >
        ...
        <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-5">
          <Card
            ...
            onClick={() => router.push("/educator-one-dashboard/modules")}
          >
          ...
          <Card
            ...
            onClick={() => router.push("/educator-one-dashboard/voice")}
          >
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <Card
            ...
            onClick={() => router.push("/educator-one-dashboard/questions")}
          >
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <Card
            ...
            onClick={() => router.push("/educator-one-dashboard/history-quiz")}
          >
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">
                Average Quiz Score
          ...
          <Card
            ...
            onClick={() => router.push("/educator-one-dashboard/history-voice")}
          >
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-1">
            <Card
              ...
              onClick={() =>
                router.push("/educator-one-dashboard/history-quiz")
              }
            >
          ...
          <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-1">
            <Card
              className="col-span-6 bg-white shadow-md rounded-lg overflow-hidden"
              onClick={() =>
                router.push("/educator-one-dashboard/history-voice")
              }
            >
              <CardHeader className="bg-yellow-200 p-4">
                <CardTitle className="text-lg font-bold text-gray-800">
